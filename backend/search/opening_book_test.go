...
func TestOpeningBookBlockPerCorner(t *testing.T) {
	...
	want := map[game.Player][]game.Pos{
		1: {p(1, 1), p(2, 1), p(2, 2)},       // base (0,0) — wedge, halo 1 (vs-ai2.48)
		2: {p(9, 9), p(9, 10), p(10, 10)},    // base (11,11)
		3: {p(1, 10), p(2, 9), p(2, 10)},     // base (0,11)
		4: {p(9, 1), p(9, 2), p(10, 1)},      // base (11,0)
	}
	...
	oddWant := map[game.Player][]game.Pos{
		1: {p(1, 1), p(2, 1), p(2, 2)},       // base (0,0)
		2: {p(10, 10), p(10, 11), p(11, 11)}, // base (12,12)
	}
