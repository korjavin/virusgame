...
func TestTurnAlignedSearchIsDeterministicAndNodeBudgetExact(t *testing.T) {
	...
	for _, fixture := range []struct {
		...
		{"maxn", three, Result{Action: move(0, 1), Score: 4123, Depth: 3, Nodes: 1000, Evaluations: 772, BudgetExhausted: true, CompletedTurnDepth: 1, Workers: 1, RootLegal: 6, RootSelected: 6, RootCompleted: 6, IterationsStarted: 2, IterationsCompleted: 1}},
	} {
		t.Run(fixture.name, func(t *testing.T) {
